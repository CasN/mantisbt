...
define( 'FILTER_PROPERTY_DUE_START_DAY', 'duedate_start_day' );
define( 'FILTER_PROPERTY_DUE_START_MONTH', 'duedate_start_month' );
define( 'FILTER_PROPERTY_DUE_START_YEAR', 'duedate_start_year' );
define( 'FILTER_PROPERTY_DUE_END_DAY', 'duedate_end_day' );
define( 'FILTER_PROPERTY_DUE_END_MONTH', 'duedate_end_month' );
define( 'FILTER_PROPERTY_DUE_END_YEAR', 'duedate_end_year' );
